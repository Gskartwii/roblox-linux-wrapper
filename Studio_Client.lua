(function(...)
	...
	function registerPlay(key)
		if true and game:GetService("CookiesService"):GetCookieValue(key) == "" then
			game:GetService("CookiesService"):SetCookieValue(key, "{ \34userId\34 : 0, \34placeId\34 : -1, \34os\34 : \34" .. settings().Diagnostics.OsPlatform .. "\34 }")
		end
	end
	...
	local success, err = pcall(function()
		...
		playerConnectSucces, player = pcall(function() return client:PlayerConnect(0, "localhost", 60870, 0, threadSleepTime) end)
		if not playerConnectSucces then
			--Old player connection scheme
			player = game:GetService("Players"):CreateLocalPlayer(0)
			analytics("Created Player")
			client:Connect("localhost", 60870, 0, threadSleepTime)
		else
			analytics("Created Player")
		end
